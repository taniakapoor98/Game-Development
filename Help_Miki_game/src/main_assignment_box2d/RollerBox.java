...
public class RollerBox  {
	...
	public RollerBox(float sx, float sy, float vx, float vy, float radius, Color col, float mass, float rollingFriction, int numSides) {
		this(sx, sy, vx, vy, radius, col, mass, rollingFriction,mkRegularPolygon(numSides, radius),numSides);
	}
	public RollerBox(float sx, float sy, float vx, float vy, float radius, Color col, float mass, float rollingFriction, Path2D.Float polygonPath, int numSides) {
		...
		vertices[0]=new Vec2(0.35f,.15f);
		vertices[1]=new Vec2(-0.35f,.15f);
		vertices[2]=new Vec2(-0.35f,-.15f);
		vertices[3]=new Vec2(0.35f,-.15f);
